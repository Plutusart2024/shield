...
export default component$(() => {
  ...
  const items = [
    { id: 'essential-container', label: 'Marketplace' },
    { id: 'optional-container', label: 'Community' },
    { id: 'advanced-container', label: 'Security' },
  ];
  ...
  <div class="flex justify-center flex-wrap items-stretch gap-6 mb-4 relative">
    ...
    <div class="flex justify-center flex-col items-center gap-6">
      ...
      <div class="rounded-box bg-front shadow-md w-96 p-4">
        <h3 class="text-primary text-2xl">Plooty Shield Progress</h3>
        <p class="text-lg">
          Security completed <b>{totalProgress.value.completed} out of {totalProgress.value.outOf}</b> items
        </p>
        <progress
          class="progress w-80"
      ...
      <div class="p-4 rounded-box bg-front shadow-md w-96 flex-grow">
        <p class="text-sm opacity-80 mb-2">
          ...
          privacy-respecting marketplace and services.
        </p>
        <p class="text-lg">
          View our Security directory of plooty.xyz,
          at <a class="link link-secondary font-bold" href="https://plooty.xyz">plooty-shield.xyz</a>
        </p>
      </div>
    </div>
