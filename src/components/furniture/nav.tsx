      ...
      <div class="navbar bg-base-100">
        <div class="flex-1">
          ...
          <a href="/" class="btn btn-ghost text-xl flex capitalize">
            <label for="my-drawer-3" aria-label="open sidebar" class="tooltip tooltip-bottom" data-tip="View all Pages">
              <Icon class="mr-2" icon="shield" width={28} height={28}  /></label>
        ...
        <div class="flex-none hidden md:flex">
          <ul class="menu menu-horizontal px-1">
            ...
            <li>
              <a href="https://plooty-xyz-update.vercel.app/" target="_blank"
                class="tooltip flex tooltip-bottom" data-tip="Go To Marketplace">
                <Icon icon="github" width={16} height={16}  />Marketplace
              </a>
            </li>
          </ul>
      ...
      <div class="drawer-side z-10">
        ...
        <ul class="rounded-box menu p-4 w-80 min-h-full bg-base-200">
          ...
          <li>
            ...
            <ul>
              <li>
                <a href="https://plooty-xyz-update.vercel.app/">Contributing</a>
              </li>
              <li>
                <a href="https://plooty-xyz-update.vercel.app//LICENSE">License</a>
              </li>
            </ul>
            <ul>
            <li>
